 ...
 * </ol>
 */
public class WXBizMsgCrypt implements Serializable {
    private static final long serialVersionUID = 4552791734880343806L;
    ...
    public String encryptMsg(String replyMsg, String timestamp, String nonce) throws AesException {
        // 加密
        String encrypt = encrypt(RandomUtil.getRandomString(16), replyMsg);

        // 生成安全签名
        if(StringUtils.isEmpty(timestamp)) timestamp = Long.toString(System.currentTimeMillis());
        if(StringUtils.isEmpty(nonce)) nonce = RandomUtil.getRandomCode(16);

        String signature = generateSignature(token, timestamp, nonce, encrypt);
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptMsg(String msgSignature, String timestamp, String nonce, String encryptData)
            throws AesException {
        // 验证安全签名
